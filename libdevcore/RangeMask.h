...
public:
	...
	RangeMask operator-(RangeMask const& _m) const { auto ret = *this; return ret -= _m; }
	RangeMask& operator-=(RangeMask const& _m) { return invert().unionWith(_m).invert(); }
...
RangeMask& RangeMask::unionWith(typename RangeMask::Range const& _m)
{
